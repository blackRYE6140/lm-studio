...
export function renderLetterDoc(data, opts = {}) {
  ...
  const fontFace = opts.fontFace ?? `@font-face { font-family: "Liberation Serif"; src: url("/fonts/LiberationSerif-Regular.ttf") format("truetype"); }`;
  ...
  const body = `
<div class="expediteur">${escapeHtml(d.expediteur.nom)}<br>${escapeHtml(d.expediteur.adresse)}<br>${contactTel}${contactMail}${contactSite}</div>
